...
import org.eclipselabs.emf.ceson.test.family.Parent;
 ...
 * <ul>
 *   <li>{@link org.eclipselabs.emf.ceson.test.family.impl.ParentImpl#getChildren <em>Children</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParentImpl extends PersonImpl implements Parent {
	...
	protected EClass eStaticClass() {
		return FamilyPackage.Literals.PARENT;
	}
	...
	public EList<Child> getChildren() {
		if (children == null) {
			children = new EObjectResolvingEList<Child>(Child.class, this, FamilyPackage.PARENT__CHILDREN);
		}
		return children;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FamilyPackage.PARENT__CHILDREN:
				return getChildren();
		}
