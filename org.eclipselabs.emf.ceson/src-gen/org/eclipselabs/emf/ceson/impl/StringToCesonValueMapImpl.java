...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>String To Ceson Value Map</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipselabs.emf.ceson.impl.StringToCesonValueMapImpl#getTypedKey <em>Key</em>}</li>
 *   <li>{@link org.eclipselabs.emf.ceson.impl.StringToCesonValueMapImpl#getTypedValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StringToCesonValueMapImpl extends MinimalEObjectImpl.Container implements BasicEMap.Entry<String,CesonValue> {
	 ...
	 * @generated
	 */
	protected StringToCesonValueMapImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return CesonPackage.Literals.STRING_TO_CESON_VALUE_MAP;
	}
	...
	public void setTypedKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CesonPackage.STRING_TO_CESON_VALUE_MAP__KEY, oldKey, key));
	}
	...
	public void setTypedValue(CesonValue newValue) {
		if (newValue != value) {
			...
			if (value != null)
				msgs = ((InternalEObject)value).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CesonPackage.STRING_TO_CESON_VALUE_MAP__VALUE, null, msgs);
			if (newValue != null)
				msgs = ((InternalEObject)newValue).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CesonPackage.STRING_TO_CESON_VALUE_MAP__VALUE, null, msgs);
			msgs = basicSetTypedValue(newValue, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CesonPackage.STRING_TO_CESON_VALUE_MAP__VALUE, newValue, newValue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CesonPackage.STRING_TO_CESON_VALUE_MAP__KEY:
				return getTypedKey();
			case CesonPackage.STRING_TO_CESON_VALUE_MAP__VALUE:
				return getTypedValue();
		}
